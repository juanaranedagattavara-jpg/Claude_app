# Iconos PNG básicos para la extensión Chrome

## Crear iconos PNG desde SVG

Para generar los iconos PNG necesarios, puedes usar cualquiera de estos métodos:

### Método 1: Herramientas online (Recomendado)
1. Ve a https://convertio.co/svg-png/
2. Sube cada archivo SVG (icon16.svg, icon32.svg, icon48.svg, icon128.svg)
3. Descarga como PNG con el tamaño correspondiente
4. Coloca los archivos PNG en esta carpeta

### Método 2: Usar ImageMagick
```bash
...
### Método 3: Usar Node.js con sharp
```bash
npm install sharp
node -e "
...
## Nota temporal
Por ahora, la extensión funcionará con los archivos SVG, pero Chrome prefiere PNG para mejor compatibilidad.